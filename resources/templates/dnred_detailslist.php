...
$id=$variables['id'];
 $dnredDetails=dnred_details($id);
 $other_story=dnred_story($id);
 //print_r($newsDetails);
 //print_r($other_story);
?>
<body>
        ...
        <div class="row">
           <div class="col-sm-8">
               <div class="dnred_right_text">
                  <?php echo $dnredDetails[0]['content']?>
            ...
            <div class="col-sm-4">
               <div class="drned_right_bar">
                ...
                <!--<div class="share_it_section newsletter_right">
                   <h4>Newsletter</h4>
                    <input type="email" placeholder="Email Address" class="input_fields">
              ...
              $image_path='https://app.iplasma.life/custom/domain_1/image_files/sitemgr_photo_';
               ?>
                <div class="small_event_section_box">
                    <div class="small_event_section_box_img">
                        <!--<img  src="images/small_event.png" alt=""/>-->
                        <a href='dnred_details.php?id=<?php echo $val['id']?>'><img src="<?php echo $img_path.$val['image_id'].".".$val['img_ext']?>" alt=""/></a>
                    </div>
